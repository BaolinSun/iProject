...
LastEditTime: 2022-02-19 21:27:30
...
class MaskKernelHead(nn.Module):
    ...
    def __init__(
        ...
        self.loss_cate = FocalLoss(use_sigmoid=True,
                                   gamma=2.0,
                                   alpha=0.25,
    ...
    def split_feats(self, feats):
        return (F.interpolate(feats[0],
                              ...
                              mode='bilinear',
                              align_corners=False,
                              recompute_scale_factor=True), feats[1], feats[2],
                feats[3],
    ...
    def loss(self,
        ...
        loss_cate = self.loss_cate(flatten_cate_preds,
                                   flatten_cate_labels,
                                   avg_factor=num_ins + 1)
        return dict(loss_ins=loss_ins, loss_cate=loss_cate)

    def get_gt_label(self, gt_bboxes_raw, gt_labels_raw, gt_masks_raw,
                     mask_feat_size):
