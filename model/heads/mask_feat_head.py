'''
Author: sunbaolin
Date: 2022-02-04 17:30:35
LastEditors: sunbaolin
LastEditTime: 2022-02-07 18:39:19
Description: file content
FilePath: /iProject/model/heads/mask_feat_head.py
'''
...
class MaskFeatHead(nn.Module):
    ...
    def __init__(
        ...
        self.conv_pred = nn.Sequential(
            nn.Conv2d(self.out_channels, self.num_classes, 1, padding=0, bias=False),
            nn.GroupNorm(num_channels=self.out_channels, num_groups=32),
...
if __name__ == '__main__':
    mask_feat_head = MaskFeatHead(in_channels=256,
                        out_channels=128,
                        start_level=0,
                        end_level=3,

                        num_classes=128)
    print(mask_feat_head)