...
LastEditTime: 2022-02-16 14:55:26
Description: file content
FilePath: /iProject/models/backbones/resnet.py
'''
...
def resnext50_32x4d(pretrained=False, loadpath=None, progress=True, **kwargs):
    ...
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3], pretrained, loadpath, progress,
                    **kwargs)


def resnext101_32x8d(pretrained=False, loadpath=None, progress=True, **kwargs):
    ...
    return _resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3], pretrained, loadpath, progress,
                    **kwargs)
